...
class MazeDrawer:
    ...
    def draw_image(self, x, y, player):
        ...
        resized, w, h = self.m.mlx_png_file_to_image(self.mlx_ptr, resized_path)
        ...
        if resized:
            ...
            self.m.mlx_put_image_to_window(self.mlx_ptr, self.win_ptr, resized, px + offset_x, py + offset_y)
        return resized